...
export default function Submission({ submissionData, isOwner, challengeData }) {
  const { id, createdAt, content, user, _count } = submissionData;
  const { title, field, documentType } = challengeData;
